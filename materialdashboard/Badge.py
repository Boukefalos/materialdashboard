...
- variant (a value equal to: "standard", "dot"; optional):
    ...
    _type = 'Badge'
    @_explicitize_args
    def __init__(self, children=None, component=Component.UNDEFINED, classes=Component.UNDEFINED, color=Component.UNDEFINED, sx=Component.UNDEFINED, variant=Component.UNDEFINED, anchorOrigin=Component.UNDEFINED, components=Component.UNDEFINED, componentsProps=Component.UNDEFINED, overlap=Component.UNDEFINED, badgeContent=Component.UNDEFINED, invisible=Component.UNDEFINED, max=Component.UNDEFINED, showZero=Component.UNDEFINED, className=Component.UNDEFINED, style=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'anchorOrigin', 'badgeContent', 'className', 'classes', 'color', 'component', 'components', 'componentsProps', 'invisible', 'max', 'overlap', 'showZero', 'style', 'sx', 'variant']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'anchorOrigin', 'badgeContent', 'className', 'classes', 'color', 'component', 'components', 'componentsProps', 'invisible', 'max', 'overlap', 'showZero', 'style', 'sx', 'variant']
