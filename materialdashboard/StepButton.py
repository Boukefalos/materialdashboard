...
- children (a list of or a singular dash component, string or number; optional):
    Can be a `StepLabel` or a node to place inside `StepLabel` as
...
- optional (boolean | number | string | dict | list; optional):
