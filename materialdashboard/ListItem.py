...
- children (a list of or a singular dash component, string or number; optional):
    The content of the component if a `ListItemSecondaryAction` is
    used it must be the last child.   The content of the component.

- id (string; optional)

- ContainerComponent (boolean | number | string | dict | list | a value equal to: "object", "div", "abbr", "address", "article", "aside", "b", "bdi", "bdo", "big", "blockquote", "caption", "cite", "code", "col", "colgroup", "dd", "del", "details", "dfn", "dt", "em", "embed", "figcaption", "figure", "footer", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "i", "iframe", "img", "input", "kbd", "keygen", "legend", "main", "mark", "menu", "menuitem", "meter", "nav", "noindex", "noscript", "output", "p", "picture", "rp", "rt", "ruby", "s", "samp", "section", "small", "span", "strong", "sub", "summary", "sup", "table", "tbody", "td", "tfoot", "th", "thead", "time", "tr", "u", "var", "wbr", "webview"; optional):
    The container component used when a `ListItemSecondaryAction` is
    the last child.

- ContainerProps (boolean | number | string | dict | list; optional):
...
- alignItems (a value equal to: "center", "flex-start"; optional):
...
- button (boolean; optional):
    If `True`, the list item is a button (using `ButtonBase`). Props
    intended for `ButtonBase` can then be applied to `ListItem`.
...
- secondaryAction (boolean | number | string | dict | list; optional):
