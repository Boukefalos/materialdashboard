...
- children (a list of or a singular dash component, string or number; optional):
    Label contents, the arrow will be appended automatically.   The
    content of the component.

- id (string; optional)

- IconComponent (boolean | number | string | dict | list; optional):
    Sort icon to use.
...
- active (boolean; optional):
    If `True`, the label will have the active styling (should be True
...
- direction (a value equal to: "desc", "asc"; optional):
