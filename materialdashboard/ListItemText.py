...
- disableTypography (boolean; optional):
    ...
    component. This can be useful to render an alternative Typography
    variant by wrapping the `children` (or `primary`) text, and
...
- inset (boolean; optional):
    If `True`, the children are indented. This should be used if there
    is no left avatar or left icon.
...
- primary (boolean | number | string | dict | list; optional):
    The main content element.

- primaryTypographyProps (boolean | number | string | dict | list; optional):
...
- secondary (boolean | number | string | dict | list; optional):
    The secondary content element.

- secondaryTypographyProps (boolean | number | string | dict | list; optional):
