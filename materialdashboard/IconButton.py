...
- children (a list of or a singular dash component, string or number; optional):
    The icon to display.   The content of the component.
...
- color (a value equal to: "inherit", "success", "info", "warning", "error", "primary", "secondary", "default"; optional):
